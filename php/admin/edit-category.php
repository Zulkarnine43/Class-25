...
if(isset($_POST['btn'])){
  ...
  $link=mysqli_connect("localhost","root","","php");
  $sql = "UPDATE addcategory SET  categoryName='$data[categoryName]',categoryDescription='$data[categoryDescription]'";
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="categoryName" class="form-control" value="<?php echo $row['categoryName'];  ?>" id="Name" placeholder="Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Description" class="col-sm-3 col-form-label">Category Description</label>
                            <div class="col-sm-9">
                                <input type="text" name="categoryDescription" class="form-control"  value="<?php echo $row['categoryDescription'];  ?> " id="Description" placeholder="Category Description">
                            </div>
                        </div>
                        <div class="form-group row">
